...
/**
 * Adopted from https://rosettacode.org/wiki/Percentage_difference_between_images#Kotlin
 */
internal fun differencePercent(img1: BufferedImage, img2: BufferedImage): Double {
